...
import com.krish512.k_exchange.Splashscreen;
...
public class App42GCMService extends GCMBaseIntentService {
	...
	static final String LARGE_IMAGE_URL = "R.drawable.ic_launcher.png";
	static int msgCount = 0;

	/**
	 * Intent used to display a message in the screen.
	 */
	static final String DISPLAY_MESSAGE_ACTION = "com.krish512.k_exchange.DISPLAY_MESSAGE";
	...
	public void generateNotification(Context context, String message) {
		...
		Notification notification = new NotificationCompat.Builder(context)
				...
				.setLights(Color.BLUE, 1000, 5000).setAutoCancel(true).build();
